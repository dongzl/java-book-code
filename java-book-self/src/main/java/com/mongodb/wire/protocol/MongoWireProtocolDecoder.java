 ...
 */
public class MongoWireProtocolDecoder extends LengthFieldBasedFrameDecoder {
    ...
    public MongoWireProtocolDecoder() {
    ...
    protected ClientRequest decode(ChannelHandlerContext ctx, ByteBuf buf) throws Exception {
        ...
        final de.bwaldvogel.mongo.wire.message.MessageHeader header = new de.bwaldvogel.mongo.wire.message.MessageHeader(requestID, responseTo);
    ...
    private ClientRequest handleDelete(Channel channel, de.bwaldvogel.mongo.wire.message.MessageHeader header, ByteBuf buffer) throws IOException {
    ...
    private ClientRequest handleUpdate(Channel channel, de.bwaldvogel.mongo.wire.message.MessageHeader header, ByteBuf buffer) throws IOException {
    ...
    private ClientRequest handleInsert(Channel channel, de.bwaldvogel.mongo.wire.message.MessageHeader header, ByteBuf buffer) throws IOException {
